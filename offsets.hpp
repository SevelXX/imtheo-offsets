...
namespace offsets {
    ...
    namespace CharacterMesh {
        ...
        inline constexpr uintptr_t BodyPart = 0x10C;
    ...
    namespace Instance {
        ...
        inline constexpr uintptr_t AttributeList = 0x0;
        inline constexpr uintptr_t AttributeToNext = 0x20;
        inline constexpr uintptr_t AttributeToValue = 0x0;
